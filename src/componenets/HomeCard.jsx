...
const HomeCard = ({ data }) => {
  ...
  return (
    <div className=" card bg-base-100 shadow-xl max-w-screen-2xl mx-auto w-full  hover:shadow-2xl transition-all duration-300 rounded-2xl border border-gray-200 ">
